...
from .deformable_transformer import MSDeformableAttention,MSDeformableAttention_key_aware
...
@register
class DAMS_DETR_Transformer(nn.Layer):
    ...
    def __init__(self,
                 ...
                 eval_idx=-1,
                 eps=1e-2,):
        super(DAMS_DETR_Transformer, self).__init__()
